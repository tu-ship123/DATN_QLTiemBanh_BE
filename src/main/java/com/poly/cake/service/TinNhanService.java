...
import com.poly.cake.dto.TomTatHoiThoaiDto;
...
public class TinNhanService {
    ...
    public List<TomTatHoiThoaiDto> getConversations() {
    ...
    public TinNhanDto guiTinNhan(Long khachHangId, Long nguoiGuiId, String noiDung, boolean tuCuaHang) {
        NguoiDung khachHang = nguoiDungRepository.findById(khachHangId)
                .orElseThrow(() -> new NgoaiLeKhongTimThayTaiNguyen("Không tìm thấy khách hàng!"));
        NguoiDung nguoiGui = nguoiDungRepository.findById(nguoiGuiId)
                .orElseThrow(() -> new NgoaiLeKhongTimThayTaiNguyen("Không tìm thấy người gửi!"));
