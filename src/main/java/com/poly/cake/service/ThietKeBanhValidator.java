 ...
 */
@Component
public class ThietKeBanhValidator {
     ...
     * @throws NgoaiLeNghiepVu nếu JSON không hợp lệ hoặc thiếu kích thước
     */
    public Map<String, Object> validateAndParse(String cakeDesignJson) {
        ...
        if (!(khungObj instanceof Map)) {
            throw new NgoaiLeNghiepVu("Trường 'khung' trong thiết kế 3D không đúng cấu trúc!");
        }
        ...
        if (!(kichThuocObj instanceof Map)) {
            throw new NgoaiLeNghiepVu("Trường 'kich_thuoc' trong thiết kế 3D không đúng cấu trúc!");
        }
