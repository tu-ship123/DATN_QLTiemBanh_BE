...
import com.poly.cake.security.DichVuChiTietNguoiDung;
...
public class CauHinhUngDung {
    ...
    private final DichVuChiTietNguoiDung userDetailsService;
    ...
    // Dùng để gọi API xác thực Google ID Token (tokeninfo) trong đăng nhập Google
    @Bean
