...
import com.poly.cake.service.BaoCaoService;
...
// CauHinhBaoMat -> nếu thiếu @PreAuthorize thì bất kỳ user đã đăng nhập nào (kể cả
// khách hàng) cũng xem được doanh thu, bảng lương nhân viên, đối soát giao dịch.
@PreAuthorize("hasRole('ADMIN')")
public class BaoCaoController {

    private final BaoCaoService reportService;

    public BaoCaoController(BaoCaoService reportService) {
