...
import com.poly.cake.service.NhanVienService;
...
public class NhanVienController {
    ...
    @PostMapping
    public ResponseEntity<?> createStaff(@Valid @RequestBody NhanVienDto.CreateRequest request) {
        // Không cần try-catch nữa! BoXuLyNgoaiLeToanCuc sẽ tự bắt lỗi nếu có.
        return ResponseEntity.ok(staffService.createStaff(request));
    }
    @PutMapping("/{id}")
    public ResponseEntity<?> updateStaff(@PathVariable Long id, @Valid @RequestBody NhanVienDto.UpdateRequest request) {
